...
void main() {
  ...
  // if (mod(uv.y, 2.0) == 0.0) {
  //   posX = (radius + (width * uv.y)) * cos(uv.y * angle);
  //   posY = (radius + (width * uv.y)) * sin(uv.y * angle);
  //   // posZ = radius * sin(totalLoops * (uv.y * angle));

  // } else {

  //   posX = (radius + (width * uv.y) + width) * cos(uv.y * angle);
  //   posY = (radius + (width * uv.y) + width) * sin(uv.y * angle);
